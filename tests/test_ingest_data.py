...
def sample_data_dir():
    ...
    def test_init(self, mock_mongo_uri, mock_db_name, mock_schema_path):
    ...
    def test_connect_success(self, mock_mongo_client, ingestor):
    ...
    def test_connect_failure(self, mock_exit, mock_mongo_client, ingestor):
    ...
    def test_clean_collections_success(self, ingestor):
    ...
    def test_clean_collections_no_entities(self, ingestor):
    ...
    @patch('mongodb.ingest_data.sys.exit')
    def test_clean_collections_error(self, mock_exit, ingestor):
    ...
    def test_load_schema_from_file(self, ingestor, sample_schema):
    ...
    def test_load_schema_from_url(self, mock_httpx_get, ingestor, sample_schema):
    ...
    @patch('mongodb.ingest_data.sys.exit')
    def test_load_schema_file_not_found(self, mock_exit, ingestor):
    ...
    def test_validate_data_success(self, mock_entity, mock_validate, ingestor, sample_schema, sample_entity):
    ...
    @patch('mongodb.ingest_data.validate')
    def test_validate_data_json_schema_error(self, mock_validate, ingestor, sample_schema, sample_entity):
    ...
    @patch('mongodb.ingest_data.validate')
    @patch('mongodb.ingest_data.Entity')
    def test_validate_data_pydantic_error(self, mock_entity, mock_validate, ingestor, sample_schema, sample_entity):
    ...
    def test_insert_entity_success(self, mock_datetime, ingestor, sample_schema, sample_entity):
    ...
    def test_insert_entity_invalid_coordinates(self, ingestor, sample_schema):
    ...
    def test_insert_entity_database_error(self, ingestor, sample_schema, sample_entity):
    ...
    def test_ingest_file_single_entity(self, ingestor, sample_entity):
    ...
    def test_ingest_file_multiple_entities(self, ingestor, sample_entity):
    ...
    def test_ingest_file_validation_errors(self, ingestor, sample_entity):
    ...
    def test_close_no_client(self, ingestor):
...
class TestIngestDataWithSampleFiles:
    ...
    def test_ingest_emsl_sample(self, mock_ingestor, sample_data_dir):
    ...
    def test_ingest_nmdc_sample(self, mock_ingestor, sample_data_dir):
    ...
    def test_ingest_all_sample_files(self, mock_ingestor, sample_data_dir):
